...
function Get-PeptideStackInfo($slug, $category) {
  switch ($slug) {
    "tirzepatide" { return @{ title = "Semaglutide, Cagrilintide, and Retatrutide"; pairing = "Tirzepatide is usually discussed alongside other metabolic compounds such as Semaglutide, Cagrilintide, and Retatrutide when people are comparing appetite and body-composition focused research categories."; why = "People usually look at these names together because they sit in a similar part of the supplier catalog, even if the signaling profile is not exactly the same from one compound to the next."; note = "This kind of page is best used as a shortcut into the product listing and broader category, not as a protocol or dosing guide." } }
    "semaglutide" { return @{ title = "Tirzepatide and Cagrilintide"; pairing = "Semaglutide is usually grouped with Tirzepatide and Cagrilintide on metabolic supplier pages because those compounds are often browsed together by people comparing GLP-1 oriented listings."; why = "The overlap is mostly about category fit and supplier navigation, since people often want to see how clearly each site presents the product, the compound family, and the surrounding trust signals."; note = "Use the stack section as a high-level browsing aid rather than a recommendation to combine compounds." } }
    "retatrutide" { return @{ title = "Tirzepatide, Semaglutide, and Cagrilintide"; pairing = "Retatrutide is often discussed alongside Tirzepatide, Semaglutide, and Cagrilintide because visitors usually encounter it while comparing the newer wave of metabolic and incretin-related product listings."; why = "People usually browse these names together to understand how the compound is positioned, how complex the signaling profile sounds, and which supplier pages make that difference easiest to understand."; note = "This section is meant to help you navigate related catalog entries, not suggest that compounds should be combined in real-world use." } }
    ...
    "bpc-157" { return @{ title = "TB-500 and GHK-Cu"; pairing = "BPC-157 is commonly discussed alongside TB-500 and sometimes GHK-Cu because those names often show up together in repair, recovery, and tissue-support focused product categories."; why = "People usually group them together because they are browsing injury, recovery, or restoration-oriented pages and want to compare which supplier presents each option most clearly."; note = "This is a category-level pairing section and should not be read as a treatment or stack instruction." } }
    "tb-500" { return @{ title = "BPC-157 and GHK-Cu"; pairing = "TB-500 is usually mentioned alongside BPC-157 and sometimes GHK-Cu because those compounds frequently appear together in recovery and repair-oriented supplier catalogs."; why = "People typically check these names together when they want to compare how each product is framed and whether the supplier makes the recovery angle easy to understand."; note = "The pairing is about related research themes and browsing patterns, not about making real-world combination claims." } }
    "ghk-cu" { return @{ title = "BPC-157, TB-500, and Glow"; pairing = "GHK-Cu is often discussed next to BPC-157, TB-500, and appearance-oriented blend products like Glow because supplier catalogs often place them in the same recovery, skin, or restoration neighborhood."; why = "People usually browse these pages together when they are looking for skin, collagen, repair, or appearance-related categories and want to see which supplier page feels the clearest."; note = "Use these pairings to discover nearby research categories, not as a stack blueprint." } }
    ...
    "epitalon" { return @{ title = "NAD+ and Thymalin"; pairing = "Epitalon is often discussed alongside NAD+ and Thymalin because people exploring longevity-oriented categories usually browse those pages in the same session."; why = "The grouping usually reflects a broader interest in cellular-aging and longevity-related research rather than a single peptide family."; note = "Think of this as a related-longevity browsing path, not a recommendation to combine compounds." } }
